...
I tried making a "notes app" or word editor from scratch to see how hard it would be to build one with no libraries, and quickly learned why most companies use third party software instead of their own(
...
## Personal Standing on Project
 ...
 UI still needs work, it's not bad but still feels kinda hacked together in certain parts
